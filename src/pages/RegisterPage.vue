  ...
  <div class="min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-sm">
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="text-2xl font-bold text-slate-900">Join the Club</h1>
        <p class="text-sm text-slate-500 mt-1">Create your member account</p>
      </div>
      ...
      <div class="card p-6">
        <form @submit.prevent="submit" class="space-y-4">
          <div>
            ...
            <input v-model="form.username" class="input" type="text" placeholder="Choose a username" autocomplete="username" required />
          </div>
          <div>
            <label class="label">Email</label>
            <input v-model="form.email" class="input" type="email" placeholder="you@example.com" autocomplete="email" required />
          </div>
          <div>
        ...
        <div class="mt-4 pt-4 border-t border-slate-100 text-center">
          <p class="text-xs text-slate-500">A unique member ID will be assigned automatically</p>
        </div>
      </div>
